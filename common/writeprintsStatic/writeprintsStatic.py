...
def frequencyOfSpecialCharacters(inputText):
    ...
    # inputText = inputText.lower().replace(" ", "")
    specialCharacters = open("writeprintsStatic/writeprintresources/writeprints_special_chars.txt", "r").readlines()
...
def functionWordsPercentage(inputText):
    functionWords = open(cur_dir_path + "writeprintsStatic/writeprintresources/functionWord.txt", "r").readlines()
...
def frequencyOfPunctuationCharacters(inputText):
    ...
    inputText = str(inputText).lower()  # because its case insensitive
    inputText = inputText.lower().replace(" ", "")
    specialCharacters = open(cur_dir_path + "writeprintsStatic/writeprintresources/writeprints_punctuation.txt", "r").readlines()
    specialCharacters = [s.strip("\n") for s in specialCharacters]
    specialCharactersFrequencyDict = {}
    for c in range(0, len(specialCharacters)):
        specialChar = specialCharacters[c]
...
def misSpellingsPercentage(inputText):
    misspelledWords = open(cur_dir_path + "writeprintsStatic/writeprintresources/writeprints_misspellings.txt", "r").readlines()
